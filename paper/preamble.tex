...
\documentclass[a4paper,ngerman,index=totoc,toc=bibliography,fontsize=10,DIV=13,headinclude,twoside,BCOR=12mm,cleardoublepage=empty,final]{scrreprt}
...
\input{_minted-paper/default-pyg-prefix.pygstyle}
