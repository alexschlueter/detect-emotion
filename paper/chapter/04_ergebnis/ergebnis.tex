...
Konfiguration im Anhang \ref{Anhang.config} berechnet. Für die Action Units Lip
Stretcher und Jaw Drop hat die Zeit nicht mehr gereicht und das Training wurde
vorher abgebrochen.
% \begin{itemize}
